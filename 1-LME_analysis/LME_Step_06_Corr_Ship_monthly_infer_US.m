...
[WM,ST,NUM] = LME_correct_infer_US(P);
if ~isfield(P,'only_correct')
    ...
    if P.do_individual == 1
        % dir_save  = LME_OI('idv_corr');
        dir_save = '/n/home10/dchan/holy_kuang/LME_intercomparison/Step_05_Idv_Corr_v17/';
        file_save = [dir_save,'Corr_idv_method_',num2str(P.only_correct),'_en_',num2str(P.en),'_',P.save_lme,'_infer_US.mat'];
    else
        % dir_save  = LME_OI('rnd_corr');
        dir_save = '/n/home10/dchan/holy_kuang/LME_intercomparison/Step_06_Rnd_Corr_v17/';
        file_save = [dir_save,'Corr_rnd_method_',num2str(P.only_correct),'_en_',num2str(P.en),'_',P.save_lme,'_infer_US.mat'];
    end
end
